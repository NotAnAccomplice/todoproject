...
public class HomeController {
    ...
    @GetMapping("/todont/add")
    public String taskForm(Model model){
        model.addAttribute("task", new Task());
        return "taskform";
    }

    @PostMapping("todont/process")
    ...
    @RequestMapping("/todont/delete/{id}")
